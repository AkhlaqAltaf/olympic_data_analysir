  ...
  return Platform.OS === 'web' ? (
    <BrowserRouter>
      <Sidebar>
        ...
        <LinkStyle to="/analysis" ><Module2IconWeb  width={40} height={40} />Overall Analysis HeatMap</LinkStyle>
        <LinkStyle to="/overallanalysisheatmap" ><Module2IconWeb  width={40} height={40} />Overall Analysis Chart</LinkStyle>

        <LinkStyle to="/countrywise" ><Module2IconWeb  width={40} height={40} />CountryWise Analysis</LinkStyle>
      ...
      <Content>
        ...
        <Routes>
         ...
         <Route path='/analysis' Component={SingleLineGraph} />
          <Route path='/countrywise' Component={CountrywiseAnalysis} />
          <Route path='/athletsanalysis' Component={AthleteWiseAnalysis} />
